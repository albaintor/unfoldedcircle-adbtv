...
internal static class AppNamesHelper
{
    ...
    internal static string RemotePath => Data.Value.Path;
    internal static string DexBase64 => Data.Value.Base64;
    ...
    private sealed record HelperData(string Path, string Base64);
}
