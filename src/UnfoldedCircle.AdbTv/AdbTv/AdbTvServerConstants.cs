...
internal static class AdbTvServerConstants
{
    ...
    internal const double DefaultPollingIntervalSeconds = 5;
    internal const double MinPollingIntervalSeconds = 1;
    internal const double MaxPollingIntervalSeconds = 300;
